...
public class TestBoxable {
    ...
    public void isCompatibleWith(){
        ...
        assertTrue("Boxable should be compatible with null", boxableWithoutPrimitive.isCompatibleWith(null));
    ...
    public void isCompatibleWith_BoxableWithoutPrimitive(){
        ...
        assertTrue("Boxable should be compatible with null", boxableWithPrimitive.isCompatibleWith(null));
